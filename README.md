# vbwd-fe-admin-plugin-cms-ai

> VBWD fe-admin plugin: AI-assisted CMS authoring UI

**Type:** Admin frontend plugin · **Host app:** `vbwd-fe-admin` · **Plugin:** `cms-ai`
...
Frontend plugins use **named exports** (`export const cms-aiPlugin`).
